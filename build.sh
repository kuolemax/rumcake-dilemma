...
cargo build --bin left --features "rumcake/split-central rumcake/bluetooth rumcake/usb" --release &&
	cargo objcopy --quiet --bin left --features "rumcake/split-central rumcake/bluetooth rumcake/usb" --release -- -O binary dist/left.bin

cargo build --quiet --bin right --features "rumcake/split-peripheral" --release &&
	cargo objcopy --quiet --bin right --features "rumcake/split-peripheral" --release -- -O binary dist/right.bin
